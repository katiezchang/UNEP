...
def main():
    ...
    print(f"\nPlease upload relevant files to the 'ICAT:PATPA' folder and press Enter when done...")
    input()
    
    # Step 2: Process ICAT:PATPA files
    icat_folder = os.path.join(script_dir, 'ICAT:PATPA')
    
    # Step 3: Process CBIT files if any
    cbit_folder = os.path.join(script_dir, 'CBIT')
    cbit_files = []
    if cbit_files_env:
